...
///////////////////////////////
	...
	void Controller::setRightStickDeadzone(ControllerType type,
			short deadzone) {
		switch (type) {
			case MASTER_CONTROLLER:
...
///////////////////
	...
	void Controller::setShiftKey(ControllerType type,
			ControllerShiftButton input) {
		switch (type) {
			case MASTER_CONTROLLER:
	...
	ControllerInput Controller::convertControllerInputToType(
			ControllerType type, ControllerInput in) {
		switch (type) {
			case MASTER_CONTROLLER:
	...
	ControllerInput Controller::getControllerInputForShiftBtn(
			ControllerType type, ControllerShiftButton shiftBtn) {
